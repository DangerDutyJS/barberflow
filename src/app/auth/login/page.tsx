      ...
      >
        ...
        <div className="rounded-2xl border border-line bg-card p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-xl border border-line-2 bg-chip px-4 py-3 text-sm font-medium text-ink hover:border-zinc-500 hover:bg-chip transition-all disabled:opacity-50 mb-5"
          >
