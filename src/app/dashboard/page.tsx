    ...
    <div className="min-h-screen bg-base text-ink">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {[
            { icon: <Calendar className="w-6 h-6" />,    title: "Mis citas",   desc: "Ver listado de citas",         href: "/dashboard/citas",         soon: false },
            { icon: <Calendar className="w-6 h-6" />,    title: "Nueva cita",  desc: "Agendar cita manualmente",     href: "/dashboard/citas/nueva",   soon: false },
